...
- Slice 12: add a repo-native smoke-test harness that resets the demo dataset, exports canonical workspace/case evidence, and asserts stable seeded traces in CI.
